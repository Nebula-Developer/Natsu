...
public struct Matrix {
    ...
    public static implicit operator SKMatrix(Matrix matrix) =>
        new() {
    ...
    public static implicit operator Matrix(SKMatrix skMatrix) =>
        new() {
            Values = new float[3, 3] {
    ...
    public Bounds MapBounds(Bounds bounds) {
        ...
        return new(mappedPoints[0], mappedPoints[1], mappedPoints[2], mappedPoints[3]);
    }
    ...
    public Matrix Invert() {
        ...
        if (inverted != null) return new() { Values = inverted };
    ...
    private static float[,] CreateTranslation(float x, float y) =>
        new float[3, 3] {
            { 1, 0, x },
            { 0, 1, y },
            { 0, 0, 1 }
    ...
    private static float[,] CreateScale(float sx, float sy) =>
        new float[3, 3] {
            { sx, 0, 0 },
            { 0, sy, 0 },
            { 0, 0, 1 }
    ...
    private static float[,] CreateSkew(float kx, float ky) =>
        new float[3, 3] {
            { 1, kx, 0 },
            { ky, 1, 0 },
            { 0, 0, 1 }
    ...
    private static float[] MultiplyVector(Vector2 vector, float[,] matrix) =>
        new[] {
