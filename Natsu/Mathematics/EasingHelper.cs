...
public static class EasingHelper {
    ...
    public static EaseFunction FromEaseType(Easing ease) =>
        ease switch {
            Easing.Linear => Linear,
            Easing.QuadIn => QuadraticIn,
            Easing.QuadOut => QuadraticOut,
            Easing.QuadInOut => QuadraticInOut,
            Easing.CubicIn => CubicIn,
            Easing.CubicOut => CubicOut,
            Easing.CubicInOut => CubicInOut,
            Easing.QuartIn => QuarticIn,
            Easing.QuartOut => QuarticOut,
            Easing.QuartInOut => QuarticInOut,
            Easing.QuintIn => QuinticIn,
            Easing.QuintOut => QuinticOut,
            Easing.QuintInOut => QuinticInOut,
            Easing.SineIn => SineIn,
            Easing.SineOut => SineOut,
            Easing.SineInOut => SineInOut,
            Easing.CircIn => CircularIn,
            Easing.CircOut => CircularOut,
            Easing.CircInOut => CircularInOut,
            Easing.ExpoIn => ExponentialIn,
            Easing.ExpoOut => ExponentialOut,
            Easing.ExpoInOut => ExponentialInOut,
