...
public class SkiaCanvas(SKCanvas canvas) : ICanvas {
    ...
    public void DrawText(string text, Vector2 position, IFont font, Paint paint) => Canvas.DrawText(text, position.X, position.Y + paint.TextSize + (paint.DisableTextYCorrection ? 0 : 3), UsePaint(paint, font));
